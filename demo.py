...
import gpt_index.readers.file.base
import glob
import numpy as np
...
def process_inputs(text: str, image: np.ndarray, video: str, audio: tuple, ):
    ...
    if text_files:
        ...
        text_content = SimpleDirectoryReader(
            ...
            file_extractor={
                ".jpg": gpt_index.readers.file.base.ImageCaptionParser(),
                ".png": gpt_index.readers.file.base.ImageCaptionParser(),
                ".jpeg": gpt_index.readers.file.base.ImageParser(),
                ".wav": gpt_index.readers.file.base.VideoAudioParser(),
                ".mp4": gpt_index.readers.file.base.VideoAudioParser(),
            }
        ).load_data()
    ...
    if audio_files:
        ...
        audio_content = SimpleDirectoryReader(
            ...
            file_extractor={
                ...
                ".png": gpt_index.readers.file.base.ImageCaptionParser(),
                ".jpeg": gpt_index.readers.file.base.ImageParser(),
                ".mp3": gpt_index.readers.file.base.VideoAudioParser(),
                ".mp4": gpt_index.readers.file.base.VideoAudioParser(),
            }
        ).load_data()
...
I will give you the information provided by the user bellow, and you should classify from the 7 types of emergencies.
"""
...
examples = [
    ...
    ["", "data/small-car-accident.jpg", None, None, None,],
...
iface = gr.Interface(
    ...
    outputs=output_text,
    title="<img src='https://i.imgur.com/x1m3VDT.jpg' width='100' height='100'> منصة استجابة",
